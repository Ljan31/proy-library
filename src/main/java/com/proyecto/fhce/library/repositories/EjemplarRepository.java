...
public interface EjemplarRepository extends JpaRepository<Ejemplar, Long> {
  ...
  @Query("SELECT e FROM Ejemplar e WHERE e.libro.id_libro = :libroId " +
      "AND e.biblioteca.id_biblioteca = :bibliotecaId " +
  ...
  @Query("SELECT COUNT(e) FROM Ejemplar e WHERE e.biblioteca.id_biblioteca = :bibliotecaId " +
      "AND e.estadoEjemplar = :estado")
  Long countByBibliotecaAndEstado(
      @Param("bibliotecaId") Long bibliotecaId,
      @Param("estado") EstadoEjemplar estado);

  @Query("SELECT e FROM Ejemplar e WHERE e.biblioteca.id_biblioteca = :bibliotecaId " +
